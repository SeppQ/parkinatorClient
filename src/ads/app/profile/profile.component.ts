...
export class ProfileComponent implements OnInit {
  ...
  update() {
    ...
    if (this.buttonName != "Save") {
      ...
      this.user = new Users(-1,this.fullname,this.user.email,this.user.hash,this.user.user_type,this.user.question,this.user.answer_hash,this.user.has_disabled_badge);
